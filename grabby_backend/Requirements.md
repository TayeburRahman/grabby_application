//STARTS: Now when i order the menu, i want to see the stamp in the menu, if i have enough stamp to get a free menu, then i can get a free menu. That system should to like, 
...
//END =you can check my project full requirements ================================
